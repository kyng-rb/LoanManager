...
namespace LoanManager.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230830031806_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoanManager.Domain.Entities.Server", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LoanManager.Domain.Entities.ServerCustomer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ServerCustomers");
                });

            modelBuilder.Entity("LoanManager.Domain.Entities.ServerUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LoanManager.Domain.Entities.Withheld", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LoanManager.Domain.Entities.Customer", b =>
                {
                    b.HasOne("LoanManager.Domain.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("LoanManager.Domain.Entities.Loan", b =>
                {
                    ...
                    b.HasOne("LoanManager.Domain.Entities.Customer", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("LoanManager.Domain.Entities.ServerCustomer", b =>
                {
                    ...
                    b.HasOne("LoanManager.Domain.Entities.Server", "Server")
                        .WithMany()
